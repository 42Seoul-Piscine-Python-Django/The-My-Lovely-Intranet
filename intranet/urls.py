...
urlpatterns = [
    ...
    path('post/<int:post_id>/delete', views.PostEditView.as_view(), name='post-delete'),
    path('post/<int:post_id>/comment', views.CommentView.as_view(), name='comment'),
    path('post/<int:post_id>/comment/delete', views.PostEditView.as_view(), name='comment-delete'),
